...
import { FashionDesignerShowcase } from '../fashion-designer-showcase';
import { FashionPartnersSection } from '../fashion-partners-section';
...
import { PricingCardsView } from '../../pricing/view/pricing-cards-view';
...
export function TravelLandingView() {
  return (
    <>
      ...
      <FashionDesignerShowcase designers={_designers} />

      <FashionPartnersSection partners={_partners} />
