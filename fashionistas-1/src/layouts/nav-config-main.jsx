...
export const pageLinks = [
  ...
  },
  {
    ...
    items: [
      { title: 'Home', path: paths.travel.root },
      { title: 'Events', path: paths.travel.tours },
      { title: 'Event Details', path: paths.travel.tour },
      { title: 'Tickets', path: paths.travel.checkout },
      { title: 'Order Confirmation', path: paths.travel.orderCompleted },
      { title: 'Fashion News', path: paths.travel.posts },
      { title: 'News Article', path: paths.travel.post },
