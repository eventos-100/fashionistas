  ...
  useCopilotAction({
    ...
    handler: async (action) => {
      try {
        ...
        setSubmitError('Failed to fill form fields. Please try again.');
      }
    },
  });
      ...
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            {submitError && (
              <div className="rounded-md bg-red-50 p-3 flex items-center gap-2">
            ...
            {submitSuccess && (
              <div className="rounded-md bg-green-50 p-3 flex items-center gap-2">
                ...
                <p className="text-sm text-green-800">Incident report submitted successfully!</p>
              </div>
            )}
